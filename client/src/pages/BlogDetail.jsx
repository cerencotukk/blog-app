          ...
          {isOwner && (
            <div className="space-x-3">
              <Link
                ...
                className="inline-flex items-center justify-center bg-gradient-to-r from-blue-500 to-pink-400 text-white px-4 py-2 rounded-md hover:opacity-90 hover:scale-105 transition-all shadow-sm hover:shadow font-semibold"
              >
              ...
              <button
                ...
                disabled={isDeleting}
                className="inline-flex items-center justify-center bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700 hover:scale-105 transition-all shadow-sm hover:shadow font-semibold"
              >
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
